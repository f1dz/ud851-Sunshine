...
//  DONE (20) Create a constant int to identify our loader used in DetailActivity
    private static final int ID_DETAIL_LOADER = 990;
...
//  DONE (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
    TextView tvDate, tvDescription, tvHigh, tvLow, tvHumidity, tvWind, tvPressure;
...
//      DONE (13) Find each of the TextViews by ID
        ...
        tvHigh = (TextView) findViewById(R.id.tv_high_temperature);
        tvLow = (TextView) findViewById(R.id.tv_low_temperature);
...
//      DONE (17) Throw a NullPointerException if that URI is null
        if(null == mUri) throw  new NullPointerException("URI cannot be null");
